...
echo.
echo   V5 Automatic Cloned Comfy Install with Pytorch , Triton and Sage 2 installation script 
echo This is for making a new cloned ComfyUI and installing Pytorch (Stable 2.8 and Nightly 2.9)
echo   It will install Pytorch 2.8 (Stable) or Pytorch 2.9 (Nightly) use Cuda 2.8.
...
echo.
echo Choose Stable for Pytorch 2.8 or Nightly for Pytorch 2.9
echo  It will install Pytorch 2.8 (Stable) or Pytorch 2.9 (Nightly) use Cuda 2.8.
...
if "%choice%"=="1" (
    ...
    echo Successfully compiled and installed SageAttention v2 and cleaned up.
    echo.
    pause
) else if "%choice%"=="3" (
    echo Installing SageAttention v2...
